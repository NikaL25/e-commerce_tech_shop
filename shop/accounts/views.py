                ...
                try:
                    ...
                    if is_cart_item_exists:
                         ...
                         for item in cart_item:
                              vartiation =item.variations.all()
                              product_variation.append(list(vartiation))
                         ...
                         id = []
                    for item in cart_item:
                            existing_vatiation = item.variations.all()
                            ex_var_list.append(list(existing_vatiation))
                            id.append(item.id)
